...
export const TOPICS = [
  {
    id: 'quota',
    title: '放置しても伸びない放置ゲーを作った話【生産ノルマ】',
  ...
  {
    id: 'hunt',
    title: 'クッキーをタップするゲームにボスを出した話【討伐と素材】',
  ...
  {
    id: 'numbers',
    title: '効いてる倍率を全部見せる放置ゲーにした話【研究と一覧】',
  ...
  {
    id: 'scale',
    title: '10の42乗まで増える放置ゲーの単位の話【正・載・極】',
    ...
    beats: [
      ...
      { id: 'ladder',
        ...
        lines: [
          ...
          { hold: 7500, caption: ['その先も <em>載・極・恒河沙</em>'],
            narration: 'その先も、さい、ごく、こうがしゃ、と続きます。使い切ることはまずありません。' },
        ] },
      { id: 'why',
        run: async s => { await s.autoScroll('infoTab', { by: 0.7 }, 3600); },
        lines: [
