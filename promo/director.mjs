...
//
// 行き先は概要欄ではなく説明欄。概要欄はこの自動化から書き換えられない(付与した
// スコープに channel の更新権限が無い)ので、中身を保証できない。説明欄は投稿時に
// 自分で書くので、リンクが載っていることを投稿前に確かめられる。視聴者から見ても
// タイトルをタップするだけで開く分こちらの方が近い。
